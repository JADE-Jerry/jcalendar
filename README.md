# J-Calendar
墨水屏日历，采用三色4.2寸墨水屏，展示基本月历信息，支持农历、公共假期、倒计日、天气（实时天气、每日天气）、课程表展示。<br>
...
A: 从经验上预估，大部分比较新一些的选1680，新一点的拆机屏选z98。SES的拆机屏选z21，如果是非常老的屏，选z15。实在不行的话，三个固件都刷一遍试试。<br>
明确的丝印对应如下：<br>
    |丝印|固件|
    |-----|-----|
    |P420010|1680|
...
9. Q: 充一次电能使用多久？<br>
A: 这个取决于选用的电池和使用场景，以及开发板的质量。正常情况下休眠的电流为120ua左右，刷新一次需要1.6mah。以900mah的电池、每日刷新一次举例，理论上大概可以待机半年。
